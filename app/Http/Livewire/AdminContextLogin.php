 ...
 */
class AdminContextLogin extends Component implements HasForms
{
    ...
    public function mount(): void
    {
        ...
        if (Auth::guard($guardName)->check()) {
            redirect()->route('admin-context.pages.dashboard');
        }
    ...
    public function authenticate(Request $request)
    {
        ...
        return redirect()->route('admin-context.pages.dashboard');
    }
